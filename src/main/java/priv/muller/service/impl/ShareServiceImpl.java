...
import priv.muller.dto.*;
import priv.muller.enums.BizCodeEnum;
import priv.muller.enums.ShareDayTypeEnum;
import priv.muller.enums.ShareStatusEnum;
import priv.muller.enums.ShareTypeEnum;
...
import priv.muller.mapper.ShareFileMapper;
import priv.muller.mapper.ShareMapper;
import priv.muller.model.AccountDO;
import priv.muller.model.AccountFileDO;
import priv.muller.model.ShareDO;
...
/**
 * 检查要转存的文件是否都在分享链接中
 * @param fileIds 要转存的文件ID列表
 * @param shareId 分享链接ID
 * @throws BizException 当有文件不在分享链接中时抛出异常
 */
